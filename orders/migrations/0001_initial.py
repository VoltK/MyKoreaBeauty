    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('создан', 'Создан'), ('оплачено', 'Оплачено'), ('доставлено', 'Доставлено')], default='создан', max_length=120)),
                ('shipping_total', models.DecimalField(decimal_places=2, default=20.99, max_digits=100)),
