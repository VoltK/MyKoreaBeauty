...
AWS_ACCESS_KEY_ID = os.environ.get("AWS_ACCESS_KEY_ID", "AKIAIMFAHDH6OEYUSMHQ")
AWS_SECRET_ACCESS_KEY = os.environ.get("AWS_SECRET_ACCESS_KEY", "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")
